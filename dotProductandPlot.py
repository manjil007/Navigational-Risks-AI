...
# data[columns_to_save].to_csv('closest_entity_results_with_dot_product_and_conditions.csv', index=False)
data[columns_to_save].to_csv('closest_entity_results_with_dot_product.csv', index=False)
...
# # Load the data
# data = pd.read_csv('closest_entity_results.csv')
#
# # Calculate the vector A (from player to entity)
# data['vector_a_x'] = data['entity_x_position'] - data['player_x_position']
# data['vector_a_y'] = data['entity_y_position'] - data['player_y_position']
...
# data[columns_to_save].to_csv('closest_entity_results_with_dot_product.csv', index=False)
#
# print("Dot product calculated and saved to 'closest_entity_results_with_dot_product.csv'")
...
plt.savefig('dot_product_histogram_0.1_intervals.png')
...
#
# # Load the data
# data = pd.read_csv('closest_entity_results_with_dot_product.csv')
#
# # Create the histogram with bins of size 0.2
...
# plt.ylabel('Frequency')
# plt.title('Histogram of Dot Product Values')
# plt.xticks(bins)  # Set x-ticks to align with bin edges
#
# plt.savefig('dot_product_histogram.png')
#
# # Show the plot
# plt.show()
