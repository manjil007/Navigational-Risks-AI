...
# Load the data
data = pd.read_csv('data/entity_within_three_radius.csv')
...
data[columns_to_save].to_csv('entity_within_three_with_dot_product.csv', index=False)

print("Dot product calculated and saved to 'entity_within_three_with_dot_product.csv'")


# Load the data from CSV
data = pd.read_csv('data/entity_within_three_with_dot_product.csv')  # Update the path to your CSV file
...
plt.savefig('entity_within_three_radius.png')
# Show the plot
plt.show()